    ...
    return (
        <div className="flex justify-center items-center gap-5 flex-col" id="contact">
            ...
            <span className=" font-normal text-sm md:text-lg text-center">
                ...
                <a className=" text-blue-500 font-bold" href="https://twitter.com/mayankshrma904" target="_blank" rel="noopener">
                    Twitter
                </a>{" "}
                if that&apos;s more your speed.
            </span>
            <a href="mailto:mayankshrma904@gmail.com?body=Hello" target="_blank" className="flex items-center gap-2 text-xl font-medium">
                <MailPlus /> mayankshrma904@gmail.com
            </a>
