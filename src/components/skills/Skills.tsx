...
const Skills = () => {
    ...
    return (
        <div className=" mt-8 w-full flex md:justify-center md:items-center md:text-center flex-col lg:mt-28">
            ...
            <p className=" mt-2 lg:mt-7 text-sm md:text-lg opacity-70 font-medium uppercase tracking-widest ">Crafting full stack web apps using M.E.R.N stack/NEXT JS</p>
