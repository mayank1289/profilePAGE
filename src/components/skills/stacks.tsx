...
import { docker, git,express, mongodb, nextjs, nodejs, postgresssql, css, react, redux, html, socketio, tailwind, ts } from "@/assets/skills/index";
...
export const TechStack = () => {
    const refs = {
        stage1: {
            techbox: [useRef<HTMLDivElement>(null) as React.RefObject<HTMLDivElement>, useRef<HTMLDivElement>(null) as React.RefObject<HTMLDivElement>, useRef<HTMLDivElement>(null) as React.RefObject<HTMLDivElement>, useRef<HTMLDivElement>(null) as React.RefObject<HTMLDivElement>, useRef<HTMLDivElement>(null) as React.RefObject<HTMLDivElement>],
            pins: [useRef<HTMLDivElement>(null) as React.RefObject<HTMLDivElement>, useRef<HTMLDivElement>(null) as React.RefObject<HTMLDivElement>, useRef<HTMLDivElement>(null) as React.RefObject<HTMLDivElement>, useRef<HTMLDivElement>(null) as React.RefObject<HTMLDivElement>, useRef<HTMLDivElement>(null) as React.RefObject<HTMLDivElement>],
        },
        stage2: {
            techbox: [useRef<HTMLDivElement>(null) as React.RefObject<HTMLDivElement>, useRef<HTMLDivElement>(null) as React.RefObject<HTMLDivElement>],
            pins: [useRef<HTMLDivElement>(null) as React.RefObject<HTMLDivElement>, useRef<HTMLDivElement>(null) as React.RefObject<HTMLDivElement>],
        },
        stage3: {
            techbox: [useRef<HTMLDivElement>(null) as React.RefObject<HTMLDivElement>, useRef<HTMLDivElement>(null) as React.RefObject<HTMLDivElement>],
            pins: [useRef<HTMLDivElement>(null) as React.RefObject<HTMLDivElement>, useRef<HTMLDivElement>(null) as React.RefObject<HTMLDivElement>],
