...
export function generateMetadata() {
    return {
        title: "Projects - Mayank",
        description: "Here are some of my projects that I have worked on , I love building prototypes and solving real world problems , I have worked on a variety of projects ranging from web development to mobile development , I have also worked on some open source projects , feel free to check them out",
        openGraph: {
